...
namespace PayCompute.Persistence
{
    public static class DataSeedingInitializer
    {
                                                 ...
                                                 RoleManager<IdentityRole> roleManager)
        {
            ...
            //Create Admin User
            if (userManager.FindByEmailAsync("asmaaebed95@gmail.com").Result == null)
            {
                IdentityUser user = new IdentityUser
                {
                    UserName = "asmaaebed95@gmail.com",
                    Email = "asmaaebed95@gmail.com"
                };
            ...
            //Create Staff User
            if (userManager.FindByEmailAsync("basem@gmail.com").Result == null)
            {
                IdentityUser user = new IdentityUser
                {
                    UserName = "basem@gmail.com",
